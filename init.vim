...
nnoremap <leader>4 :BufferGoto 4<Enter>
nnoremap <leader>5 :BufferGoto 5<Enter>
nnoremap <leader>6 :BufferGoto 6<Enter>
nnoremap <leader>7 :BufferGoto 7<Enter>
nnoremap <leader>8 :BufferGoto 8<Enter>
nnoremap <leader>9 :BufferGoto 9<Enter>
